...
| Tool | Purpose |
|:-----|:--------|
| [[Vulnerability_Scanners\|Nessus]] | Self-hosted vulnerability scanner (Tenable) — pentest standard |
| [[Vulnerability_Scanners\|Qualys]] | Cloud SaaS vulnerability management (agents + appliances) |
| [[Vulnerability_Scanners\|Nexpose / InsightVM]] | Rapid7 scanner with Metasploit integration |
| [[Vulnerability_Scanners\|OpenVAS / GVM]] | Open-source vulnerability scanner (Greenbone) |
