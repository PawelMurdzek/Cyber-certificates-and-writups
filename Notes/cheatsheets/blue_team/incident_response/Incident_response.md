...
| **capa** | Capability Detection | Automatically detects capabilities (APIs, instructions, patterns) in files (PE, ELF, .NET, shellcode) and maps them to MITRE ATT&CK. See [[Capa]]. |
